...
public class DDT_CSV {
	...
	public void tc_shoppingCartTesting() throws InterruptedException, IOException {
		...
		String csvTestDataFilePath = "C:\\Users\\Huser\\Desktop\\Brian SDET Files\\Test Input\\shoppingData.csv";
		String resultsToCSV = "C:\\Users\\Huser\\Desktop\\Brian SDET Files\\Test Output\\shoppingDataResults.csv";
		...
		while (testdata.readRecord()) {
			...
			item2Search = testdata.get("product");
			qty = testdata.get("qty");
			customerName = testdata.get("name");
			customerCity = testdata.get("city");
			customerState = testdata.get("state");
